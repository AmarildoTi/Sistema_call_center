...
public class AtendimentoLocalizar implements Logica{
    ...
    public void executa(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try{
            ...
            if( login != null){
                ArrayList<Divida> listaDivida = (ArrayList<Divida>) request.getSession().getAttribute("listaDivida");
                Divida divida = null;
                for(Divida d:listaDivida){
                    if (d.getId() == Integer.parseInt(request.getParameter("id"))){
                       divida = d;
                    }
                }
                ...
                atendimento =  AtendimentoDAO.localizar(atendimento);

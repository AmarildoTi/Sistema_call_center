...
public class SegmentacaoInserir implements Logica{
    ...
    public void executa(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try{
            ...
            if( login != null){
                ...
                SegmentacaoDAO.inserir(segmentacao);
                LogDAO.inserir(new Log(login,"Inseriu no cadastro um nova segmentação do atendimento: "+segmentacao.getId()));
            ...
            request.setAttribute("indexoperador2", request.getParameter("indexoperador2"));
            request.setAttribute("mensagem","Erro ao tentar inserir uma Segmentação de Atendimento!!!");
            request.getRequestDispatcher("/sistema/supervisor/segmentacao/segmentacao.jsp").forward(request, response);
        }
    }
